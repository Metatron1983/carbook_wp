...
$opt_name = 'carbook_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Опции сайта', 'mycarbook' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Sample Options', 'mycarbook' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Site settings', 'mycarbook' ),
		'id'               => 'site_settings',
		'desc'             => esc_html__( 'These are really basic fields!', 'mycarbook' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header Section', 'mycarbook' ),
		...
		'fields'           => array(
			array(
				...
				'type'         => 'media',
				'url'          => true,
				'title'        => esc_html__( 'Логотип сайта', 'mycarbook' ),
				'compiler'     => 'true',
				'desc'         => esc_html__( 'Выбирете логотип сайта', 'mycarbook' ),
				'subtitle'     => esc_html__( 'Здесь отображается логотип сайта', 'mycarbook' ),
				'preview_size' => 'medium',
				'default'	   => '',
			),
		),
